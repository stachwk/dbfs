...
def main() -> None:
    ...
    cases = [
        ((10, 0, 4), {"shrinking": True, "has_valid_blocks": False, "max_valid_block": 0, "has_partial_tail": False, "tail_block_index": 0, "tail_valid_len": 0}),
        ((10, 6, 4), {"shrinking": True, "has_valid_blocks": True, "max_valid_block": 1, "has_partial_tail": True, "tail_block_index": 1, "tail_valid_len": 2}),
        ((10, 16, 4), {"shrinking": False, "has_valid_blocks": True, "max_valid_block": 3, "has_partial_tail": False, "tail_block_index": 0, "tail_valid_len": 0}),
    ]
