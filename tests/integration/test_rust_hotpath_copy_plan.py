...
def main() -> None:
    ...
    os.environ["DBFS_RUST_HOTPATH_COPY_PLAN_BIN"] = str(ROOT / "rust_hotpath" / "target" / "debug" / "copy-plan")
    ...
    try:
        ...
        assert seen_args["cmd"][:1] == [str(ROOT / "rust_hotpath" / "target" / "debug" / "copy-plan")], seen_args
