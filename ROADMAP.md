...
- treat the current `bulk_write` vs `metadata_heavy` large-copy comparison as a baseline and move the next hot-path implementation step into a Rust POC instead of more Python tuning
